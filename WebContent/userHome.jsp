...
<head>
	...
	<%
		String[] userDetails = (String[])request.getAttribute("userData"); 
	%>
<body>
    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                <a class="navbar-brand" href="userHome.jsp">Happy Quiz</a>
            </div>
            <!-- /.navbar-header -->
            ...
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        <li>
                            <div class="text-uppercase uname-display">
                            	<center><em><strong><%= userDetails[0].split(" ")[0] %></strong></em></center>
                            </div>                          
                        </li>
                        <li></li><li></li><li></li><li></li><li></li><li></li><li></li><li></li><li></li><li></li>
                        <li>
                            <a href="userHome.jsp"><i class="fa fa-dashboard fa-fw"></i> Dashboard</a>
                        </li>
                        <li>
                            <a href="#"><i class="fa fa-bar-chart-o fa-fw"></i> My Quizzes</a>
                            
                        </li>
                        <li>
                            <a href="#"><i class="fa fa-table fa-fw"></i> Competitions</a>
                        </li>
                        <li>
