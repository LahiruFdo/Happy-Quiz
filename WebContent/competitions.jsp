...
<body>
    ...
    <div id="wrapper">
        ...
        <jsp:include page="header-nav.jsp">
		    <jsp:param name="active_page" value="competitions" />
		</jsp:include>
        <br>
        <div class="container" style="background-color: white;">
            <div class="row">
                <div class="col-lg-12">
                    <h3 class="page-header"><i class="fa fa-list-alt fa-fw" aria-hidden="true" ></i>&nbsp;&nbsp;Competitions</h3>
                </div>
            </div>
            <div class="row">
            	<div class="col-lg-12">
	                <div class="panel panel-default">
			            <div class="panel-heading">
			                <i class="fa fa-file-text" aria-hidden="true"></i>&nbsp;&nbsp;&nbsp; All Competitions
			           	</div>
